# -*- coding: utf-8 -*-
"""
Created on Tue Nov 26 18:30:43 2024
...
K_INSULATION_WALLS = 3.25  # [W/(K*m^2)]
K_INSULATION_ROOF = 3.25  # [W/(K*m^2)]
K_INSULATION_FLOOR = 0.378  # [W/(K*m^2)]
K_INSULATION_WINDOWS = 3.25  # [W/(K*m^2)]
...
greenhouse_unit_numbers = range(1,60)
...
plt.title("Contour Map of Final Furnace Power Demand_Glass")

# Save the contour map
plt.savefig(os.path.join(output_path, "furnace_power_contour_map_Glass.png"))
plt.show()
